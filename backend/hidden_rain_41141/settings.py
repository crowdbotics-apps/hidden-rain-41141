"""
Django settings for hidden_rain_41141 project.
...
ROOT_URLCONF = 'hidden_rain_41141.urls'
...
WSGI_APPLICATION = 'hidden_rain_41141.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_rain_41141 API",
    "DESCRIPTION": "API documentation for hidden_rain_41141 App",
    "VERSION": "v1",
}
